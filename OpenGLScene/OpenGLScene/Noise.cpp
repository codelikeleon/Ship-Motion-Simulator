 ...
 */
int Noise::indice( int i, int j, int k, int l ) {
 ...
 */
float Noise::prod ( float a, char b ) {
    if ( b > 0 ) return a;
    if ( b < 0 ) return -a;
    return 0;
}

float Noise::dot_prod ( float x1, char x2, float y1, char y2, float z1, char z2, float t1, char t2 ) {
